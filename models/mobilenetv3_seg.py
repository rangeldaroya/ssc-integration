# Code from https://github.com/ekzhang/fastseg/blob/master/fastseg/model/mobilenetv3.py
...
class MobileNetV3_Large(nn.Module):
    def __init__(self, trunk=tf_mobilenetv3_large_100, pretrained=False, num_inp_feats=3):
...
class MobileNetV3_Small(nn.Module):
    def __init__(self, trunk=tf_mobilenetv3_small_100, pretrained=False, num_inp_feats=3):
